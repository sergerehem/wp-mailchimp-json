<?php
/*
Plugin Name: MailChimp JSON Integration
Plugin URI: http://wordpress.org/extend/plugins/wp-mailchimp-json
Description: Wordpress MailChimp JSON Integration
Version: 1.0.0
Author: Serge Rehem
Author URI: http://ratodigital.com
*/
